...
export default function SectionDiferenciais() {
  ...
  return (
    <section  id='diferenciais' className='overflow-hidden py-20 md:py-28 scroll-mt-header'>
      <Grid>
        <div className='flex flex-col md:flex-row gap-8 text-center md:text-left items-center justify-between mb-16'>
          <h2 ref={titleRef} className='text-5xl md:text-4xl/short text-brand-gray-900'>Meus diferenciais</h2>
