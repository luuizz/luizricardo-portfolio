...
import { Plus, Youtube, Play, Clock } from "lucide-react";
import { DeleteVideoButton } from "@/app/(private)/dashboard/videos/_components/DeleteVideoButton";

export const metadata: Metadata = createDashboardMeta("Todos os Vídeos");
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">{videos.length} vídeo(s) cadastrado(s)</p>
            </div>
            ...
            <div className="flex h-64 flex-col items-center justify-center gap-4 rounded-xl border-2 border-dashed text-center">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Adicione links de YouTube, Vimeo ou outros.
                </p>
              </div>
                ...
                >
                  ...
                  <div className="p-4">
                    <div className="mb-2 flex items-center gap-2">
                      <Badge variant={STATUS_VARIANT[video.status] ?? "outline"} className="text-xs">
